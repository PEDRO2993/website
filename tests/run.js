...
const tests = ['t_i18n_build.js', 't_trabalho.js', 't_blog_i18n.js', 't_new_sections.js', 't_build_extras.js', 't_autopilot.js', 't_digest.js', 't_mobile_bar.js', 't_contact_required.js', 't_form_state.js', 'overflow.js'];
let failed = 0;
