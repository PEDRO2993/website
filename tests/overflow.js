...
(async () => { const b = await chromium.launch({ executablePath: CHROME });
  const pages = ['index.html','de/index.html','fr/index.html','blog.html','de/preco-site-suica.html','fr/multilingue-valais.html','it/google-business-valais.html','en/site-restaurante-valais.html','fr/manutencao-site.html','privacidade.html'];
  const out = [];
