/* ====================================================================
   Hotel Portjengrat Saas-Almagell — i18n (DE · FR · IT · EN)
...
de: {
  ...
  "menu.erleben": "Saas-Almagell erleben",
  ...
  "hero.sub": "Ihr Boutique-Berghotel im Sonnendorf Saas-Almagell — 300 Sonnentage, 270° Bergpanorama und ein Balkon mit Blick auf die Walliser Viertausender. Zu jedem Zimmer.",
  ...
  "bb.g5": "5+ / Familie",
  "bb.btn": "Jetzt buchen&nbsp;→",
  "bb.sub": "Sicher online buchen &amp; bezahlen oder vor Ort — Sie entscheiden. Fragen? <a href=\"tel:+41270000000\">027 000 00 00</a>",

  /* --- kinetic --- */
  "kin.1": "Panorama-Zimmer. <em>Walliser Genuss.</em> Panorama-Zimmer.",
  "kin.2": "<em>Hannigspa.</em> 300 Sonnentage. <em>Hannigspa.</em>",
  "kin.3": "Pure Erholung. <em>Einfach Portjengrat.</em> Pure Erholung.",

  /* --- intro --- */
  "intro.eyebrow": "Willkommen im Portjengrat",
  "intro.h2": "Ankommen. Durchatmen.<br><em>Bleiben wollen.</em>",
  "intro.lead": "Einfach Ferien. Einfach gut. Einfach Portjengrat. Im autofreien Dorfteil gelegen, nahe bei den Bergbahnen und fussläufig zum Dorfzentrum, zeichnet sich das Hotel Portjengrat durch tollen Service aus — begleitet von aufmerksamem und freundlichem Personal.",
  "intro.p2": "Morgens weckt Sie die Alpenwelt auf dem eigenen Balkon, tagsüber liegen Ihnen Pisten, Höhenwege und die Wälder von Saas-Almagell zu Füssen. Abends verwöhnen Sie die preisgekrönten Köche in unserem Schwesterhotel Désirée — und im Partnerhotel Hannigalp nutzen Sie das einzige Hallenschwimmbad in Saas-Almagell kostenlos.",
  ...
  "intro.badge2": "Einfach Portjengrat.",
  ...
  "rooms.foot": "«Ab»-Preise für die Nebensaison, pro Zimmer/Nacht inkl. Frühstück — in Stosszeiten höher. Der definitive Preis wird im offiziellen Buchungssystem angezeigt · exkl. Kurtaxe.",
  "avail.title": "Verfügbarkeit der nächsten Tage",
  "avail.demo": "Beispieldaten — nicht live",
  "avail.ok": "Verfügbar",
  "avail.no": "Nicht verfügbar",
  "room.maxGuest1": "Nur für 1 Gast",
  "room.maxGuests": "Max. {n} Gäste",
  ...
  "room.fewo.desc": "120 m² pures Ferienglück für bis zu 5 Personen: zwei Schlafzimmer, zwei Badezimmer, Küche mit Fondue-Rechaud und zwei Balkone.",
  "room.fewo.f1": "120 m²",
  ...
  "well.lead": "Keine zehn Gehminuten entfernt, im Partnerhotel Aktiv Hotel &amp; Spa Hannigalp, tanken Körper, Geist und Seele neue Energie: das einzige Hallenbad in Saas-Almagell und ein grosszügiger SPA-Bereich in den farbenfrohen Welten des Feng Shui.",
  "well.c1": "Hallenschwimmbad (6×12 m) mit Whirlpool — für Portjengrat-Gäste gratis",
  ...
  "well.cap": "Hannigspa — Ihre Auszeit in den Alpen, 10 Gehminuten vom Portjengrat",

  /* --- erleben --- */
  "erleben.eyebrow": "Saas-Almagell erleben",
  "erleben.h2": "365 Tage <em>Berge vor der Tür.</em>",
  "erleben.note": "Insider-Tipps unserer Gastgeber — erleben Sie Saas-Almagell und das Mattertal wie die Einheimischen.",
  ...
  "ct.addr": "<strong>Hotel Portjengrat***</strong><br>Hofe 454 · 3905 Saas-Almagell<br>Wallis, Schweiz",
  "ct.car": "Mit dem Auto",
  ...
  "ct.trainP": "SBB bis Visp, Matterhorn Gotthard Bahn bis St.&nbsp;Niklaus, dann Bus 551 bis Saas-Almagell Dorf — durch das am tiefsten eingeschnittene Tal der Schweiz.",
  "ct.checkin": "Check-in",
  ...
  /* --- footer --- */
  "ft.tag": "Boutique-Berghotel im Sonnendorf Saas-Almagell.<br>300 Sonnentage. Ein Zuhause.",
  "ft.h1": "Entdecken",
  "ft.l1": "Zimmer &amp; Suiten",
  "ft.l2": "Gastronomie",
  "ft.l3": "Wellness &amp; Spa",
  "ft.l4": "Saas-Almagell erleben",
  "ft.h2": "Kontakt",
  "ft.h3": "Direkt buchen",
  ...
  "form.errName": "Bitte geben Sie Ihren Namen ein.",
  "form.errMail": "Bitte geben Sie eine gültige E-Mail-Adresse ein.",
  "form.errMsg": "Bitte schreiben Sie eine Nachricht.",
  "form.errPhone": "Bitte prüfen Sie die Telefonnummer.",
  "form.ok": "Vielen Dank, {name}! Ihr E-Mail-Programm öffnet sich.",
  "sb.lang": "DE",
  "pay.frameTitle": "Sicheres Buchungssystem — Hotel Portjengrat",
...
(function () {
  ...
  if (window.LANG !== "de") window.applyLang(window.LANG);
    ...
    document.querySelectorAll(".lang-switch button").forEach(function (b) {
      var on = b.getAttribute("data-lang") === "de";
      b.classList.toggle("active", on);
      b.setAttribute("aria-pressed", String(on));
    });
  }
