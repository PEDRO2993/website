/* ====================================================================
   Hôtel Garni Les Berges Chippis — i18n (DE · FR · IT · EN)
...
de: {
  ...
  "hero.sub": "Ihr Boutique-Berghotel im Sonnendorf Chippis — 300 Sonnentage, 270° Bergpanorama und ein Balkon mit Blick auf die Walliser Viertausender. Zu jedem Zimmer.",
  ...
  "kin.3": "Pure Erholung. <em>Einfach Garni Les Berges.</em> Pure Erholung.",

  /* --- intro --- */
  "intro.eyebrow": "Willkommen im Garni Les Berges",
  "intro.h2": "Ankommen. Durchatmen.<br><em>Bleiben wollen.</em>",
  "intro.lead": "Einfach Ferien. Einfach gut. Einfach Garni Les Berges. Im autofreien Dorfteil gelegen, nahe bei den Bergbahnen und fussläufig zum Dorfzentrum, zeichnet sich das Hotel Garni Les Berges durch tollen Service aus — begleitet von aufmerksamem und freundlichem Personal.",
  "intro.p2": "Morgens weckt Sie die Alpenwelt auf dem eigenen Balkon, tagsüber liegen Ihnen Pisten, Höhenwege und die Wälder von Chippis zu Füssen. Abends verwöhnen Sie die preisgekrönten Köche in unserem Schwesterhotel Désirée — und im Partnerhotel Hannigalp nutzen Sie das einzige Hallenschwimmbad in Chippis kostenlos.",
  ...
  "intro.badge2": "Einfach Garni Les Berges.",
  ...
  "well.lead": "Keine zehn Gehminuten entfernt, im Partnerhotel Aktiv Hotel &amp; Spa Hannigalp, tanken Körper, Geist und Seele neue Energie: das einzige Hallenbad in Chippis und ein grosszügiger SPA-Bereich in den farbenfrohen Welten des Feng Shui.",
  "well.c1": "Hallenschwimmbad (6×12 m) mit Whirlpool — für Garni Les Berges-Gäste gratis",
  ...
  "well.cap": "Hannigspa — Ihre Auszeit in den Alpen, 10 Gehminuten vom Garni Les Berges",

  /* --- erleben --- */
  "erleben.eyebrow": "Chippis erleben",
  "erleben.h2": "365 Tage <em>Berge vor der Tür.</em>",
  "erleben.note": "Insider-Tipps unserer Gastgeber — erleben Sie Chippis und das Mattertal wie die Einheimischen.",
  ...
  "ct.addr": "<strong>Hotel Garni Les Berges***</strong><br>Hofe 454 · 3965 Chippis<br>Wallis, Schweiz",
  "ct.car": "Mit dem Auto",
  ...
  "ct.trainP": "SBB bis Visp, Matterhorn Gotthard Bahn bis St.&nbsp;Niklaus, dann Bus 551 bis Chippis Dorf — durch das am tiefsten eingeschnittene Tal der Schweiz.",
  "ct.checkin": "Check-in",
  ...
  /* --- footer --- */
  "ft.tag": "Boutique-Berghotel im Sonnendorf Chippis.<br>300 Sonnentage. Ein Zuhause.",
  "ft.h1": "Entdecken",
  "ft.l1": "Zimmer &amp; Suiten",
  "ft.l2": "Gastronomie",
  "ft.l3": "Wellness &amp; Spa",
  "ft.l4": "Chippis erleben",
  "ft.h2": "Kontakt",
  "ft.h3": "Direkt buchen",
  ...
  "sb.lang": "DE",
  "pay.frameTitle": "Sicheres Buchungssystem — Hotel Garni Les Berges",
  ...
  /* --- image alt text --- */
  "img.reception": "Empfang im Hotel Garni Les Berges",
  "img.exterior": "Hotel Garni Les Berges Aussenansicht im Sommer",
  ...
  "offer.1.alt": "Retreat Woche in Chippis",
  ...
  "tip.1.alt": "Wintersport in Chippis",
