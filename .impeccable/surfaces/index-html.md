...
OWN-WORLD: Papel #F6F5F1, tinta #101010, vermelho suíço #C8102E, cinzento-régua #D9D6CE só para linhas de grelha visíveis, azul-ardósia #2B3A55 só nas moldura dos ecrãs. Archivo variável (wdth 62–125) para tudo; display em largura expandida e peso 800, texto em largura normal. Componentes: sem cartões com sombra; blocos definidos por réguas de grelha de 1px; botões retangulares pretos/vermelhos de canto reto; números tabulares.
